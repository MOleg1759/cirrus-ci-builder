...
if [ "$1" = "--old" ]; then
function post_msg() {
    curl -s -X POST "https://api.telegram.org/bot5498602147:AAGV8n_lBIa-KmPfG884c-MC7xDlBXgRFhU/sendMessage" \
        -d chat_id="-1001817086054" \
...
function push() {
    curl -F document=@$1 "https://api.telegram.org/bot5498602147:AAGV8n_lBIa-KmPfG884c-MC7xDlBXgRFhU/sendDocument" \
         -F chat_id="-1001817086054" \
